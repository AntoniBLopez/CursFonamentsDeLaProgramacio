...
// El siguente código comentado es una prueba personal con el que he estado experimentando para
// descubrir a través de mi propia experiencia nuevas formas de almacenar, utilizar y acceder a los valores de los arrays y objetos. 05/02/022
...
//     return almacenarNumerosDecimalesDelLoop[2][20] + almacenarNumerosDecimalesDelLoop[0][add]
// }

// function cuentaTreinta(add) {
//     return almacenarNumerosDecimalesDelLoop[2][30] + " y " + almacenarNumerosDecimalesDelLoop[0][add]
// }

// function cuentaCuarenta(add) {
//     return almacenarNumerosDecimalesDelLoop[2][40] + " y " + almacenarNumerosDecimalesDelLoop[0][add]
// }

// function cuentaCincuenta(add) {
//     return almacenarNumerosDecimalesDelLoop[2][50] + " y " + almacenarNumerosDecimalesDelLoop[0][add]
// }

// function cuentaSesenta(add) {
//     return almacenarNumerosDecimalesDelLoop[2][60] + " y " + almacenarNumerosDecimalesDelLoop[0][add]
// }

// function cuentaSetenta(add) {
//     return almacenarNumerosDecimalesDelLoop[2][70] + " y " + almacenarNumerosDecimalesDelLoop[0][add]
// }

// function cuentaOchenta(add) {
//     return almacenarNumerosDecimalesDelLoop[2][80] + " y " + almacenarNumerosDecimalesDelLoop[0][add]
// }

// function cuentaNoventa(add) {
//     return almacenarNumerosDecimalesDelLoop[2][90] + " y " + almacenarNumerosDecimalesDelLoop[0][add]
// }

// for (add = 1; add < 10; add++) {
//     almacenarNumerosDecimalesDelLoop[3].push(cuentaVeinte(add))
//     almacenarNumerosDecimalesDelLoop[4].push(cuentaTreinta(add))
//     almacenarNumerosDecimalesDelLoop[5].push(cuentaCuarenta(add))
//     almacenarNumerosDecimalesDelLoop[6].push(cuentaCincuenta(add))
//     almacenarNumerosDecimalesDelLoop[7].push(cuentaSesenta(add))
//     almacenarNumerosDecimalesDelLoop[8].push(cuentaSetenta(add))
//     almacenarNumerosDecimalesDelLoop[9].push(cuentaOchenta(add))
//     almacenarNumerosDecimalesDelLoop[10].push(cuentaNoventa(add))
